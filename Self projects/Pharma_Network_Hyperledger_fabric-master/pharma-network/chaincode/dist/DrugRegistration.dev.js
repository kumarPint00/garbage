  ...
  (function (_Contract) {
    ...
    function DrugRegistrationContract() {
      ...
      return _possibleConstructorReturn(
        this,
        _getPrototypeOf(DrugRegistrationContract).call(
          this,
                ...
                switch ((_context2.prev = _context2.next)) {
                  case 0:
                    ...
                    return _context2.abrupt("return", {
                      error:
                        "Manufacturer Org can only add drugs on the pharma-network",
                    });

                  case 3:
                    //composite key for storing drug
                    productIDKey = ctx.stub.createCompositeKey(
                    ...
                    return regeneratorRuntime.awrap(
                      ctx.stub.getStateByPartialCompositeKey(
                  ...
                  case 9:
                    ...
                    _context2.next = 14;
                    return regeneratorRuntime.awrap(
                      ctx.stub.putState(productIDKey, dataBuffer)
                    );
                  ...
                  case 17:
                    ...
                    return _context2.abrupt("return", {
                      error:
                        "Unable to register Drug on the network, check input parameters",
